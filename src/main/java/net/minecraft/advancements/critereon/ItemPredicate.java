...
public class ItemPredicate {
   ...
   public ItemPredicate(@Nullable Tag<Item> pTag, @Nullable Set<Item> pItems, MinMaxBounds.Ints pCount, MinMaxBounds.Ints pDurability, EnchantmentPredicate[] pEnchantments, EnchantmentPredicate[] pStoredEnchantments, @Nullable Potion pPotion, NbtPredicate pNbt) {
      this.tag = pTag;
      this.items = pItems;
      this.count = pCount;
