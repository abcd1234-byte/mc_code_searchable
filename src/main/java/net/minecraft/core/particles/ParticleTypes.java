...
public class ParticleTypes {
   ...
   private static SimpleParticleType register(String pKey, boolean pAlwaysShow) {
      return Registry.register(Registry.PARTICLE_TYPE, pKey, new SimpleParticleType(pAlwaysShow));
   }
