...
public enum Direction implements StringRepresentable {
   ...
   public static Direction getFacingAxis(Entity pEntity, Direction.Axis pAxis) {
      switch(pAxis) {
      case X:
         return EAST.isFacingAngle(pEntity.getViewYRot(1.0F)) ? EAST : WEST;
      case Z:
         return SOUTH.isFacingAngle(pEntity.getViewYRot(1.0F)) ? SOUTH : NORTH;
      case Y:
      default:
         return pEntity.getViewXRot(1.0F) < 0.0F ? UP : DOWN;
      }
   }
   ...
   public Direction getCounterClockWise(Direction.Axis pAxis) {
      ...
      case Y:
         ...
         return this;
      default:
         throw new IllegalStateException("Unable to get CW facing for axis " + pAxis);
      }
   }
