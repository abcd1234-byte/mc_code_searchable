...
public class Layers implements LayerBiomes {
   ...
   private static <T extends Area, C extends BigContext<T>> AreaFactory<T> zoom(long pSeed, AreaTransformer1 pParent, AreaFactory<T> pArea, int pCount, LongFunction<C> pContextFactory) {
