...
public class MobSpawnSettings {
   ...
   public static class Builder {
      ...
      public MobSpawnSettings.Builder addMobCharge(EntityType<?> pEntityType, double pSpawnCostPerEntity, double pMaxSpawnCost) {
         this.mobSpawnCosts.put(pEntityType, new MobSpawnSettings.MobSpawnCost(pMaxSpawnCost, pSpawnCostPerEntity));
         return this;
      }
