...
public abstract class BiomeSource implements BiomeManager.NoiseBiomeSource {
   ...
   protected BiomeSource(Stream<Supplier<Biome>> pPossibleBiomes) {
      this(pPossibleBiomes.map(Supplier::get).collect(ImmutableList.toImmutableList()));
   }

   protected BiomeSource(List<Biome> pPossibleBiomes) {
