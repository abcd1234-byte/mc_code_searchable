...
public class GrassBlock extends SpreadingSnowyDirtBlock implements BonemealableBlock {
   ...
   private static <U extends FeatureConfiguration> BlockState getBlockState(Random pRandom, BlockPos pPos, ConfiguredFeature<U, ?> pFlowerFeature) {
      AbstractFlowerFeature<U> abstractflowerfeature = (AbstractFlowerFeature)pFlowerFeature.feature;
      return abstractflowerfeature.getRandomFlower(pRandom, pPos, pFlowerFeature.config());
   }
}