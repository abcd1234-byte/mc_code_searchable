...
public class SetBannerPatternFunction extends LootItemConditionalFunction {
   ...
   SetBannerPatternFunction(LootItemCondition[] pConditions, List<Pair<BannerPattern, DyeColor>> pPatterns, boolean pAppend) {
      super(pConditions);
   ...
   protected ItemStack run(ItemStack pStack, LootContext pContext) {
      CompoundTag compoundtag = pStack.getOrCreateTagElement("BlockEntityTag");
