...
public class DimensionType {
   ...
   @Deprecated
   private DimensionType(OptionalLong pFixedTime, boolean pHasSkylight, boolean pHasCeiling, boolean pUltraWarm, boolean pNatural, double pCoordinateScale, boolean pCreateDragonFight, boolean pPiglinSafe, boolean pBedWorks, boolean pRespawnAnchorWorks, boolean pHasRaids, int pMinY, int pHeight, int pLogicalHeight, BiomeZoomer pBiomeZoomer, ResourceLocation pInfiniburn, ResourceLocation pEffectsLocation, float pAmbientLight) {
