...
public final class NoiseGeneratorSettings {
   ...
   public boolean stable(ResourceKey<NoiseGeneratorSettings> pSettings) {
      return Objects.equals(this, BuiltinRegistries.NOISE_GENERATOR_SETTINGS.get(pSettings));
   }
   ...
   private static NoiseGeneratorSettings endLikePreset(StructureSettings pStructureSettings, BlockState pDefaultBlock, BlockState pDefaultFluid, boolean pDisableMobGeneration, boolean pIslandNoiseOverride) {
      return new NoiseGeneratorSettings(pStructureSettings, NoiseSettings.create(0, 128, new NoiseSamplingSettings(2.0D, 1.0D, 80.0D, 160.0D), new NoiseSlideSettings(-3000, 64, -46), new NoiseSlideSettings(-30, 7, 1), 2, 1, 0.0D, 0.0D, true, false, pIslandNoiseOverride, false), pDefaultBlock, pDefaultFluid, Integer.MIN_VALUE, Integer.MIN_VALUE, 0, 0, pDisableMobGeneration, false, false, false, false, false);
   }

   private static NoiseGeneratorSettings netherLikePreset(StructureSettings pStructureSettings, BlockState pDefaultBlock, BlockState pDefaultFluid) {
      ...
      return new NoiseGeneratorSettings(new StructureSettings(Optional.ofNullable(pStructureSettings.stronghold()), map), NoiseSettings.create(0, 128, new NoiseSamplingSettings(1.0D, 3.0D, 80.0D, 60.0D), new NoiseSlideSettings(120, 3, 0), new NoiseSlideSettings(320, 4, -1), 1, 2, 0.0D, 0.019921875D, false, false, false, false), pDefaultBlock, pDefaultFluid, 0, 0, 32, 0, false, false, false, false, false, false);
   }

   private static NoiseGeneratorSettings overworld(StructureSettings pStructureSettings, boolean pIsAmplified) {
      double d0 = 0.9999999814507745D;
      return new NoiseGeneratorSettings(pStructureSettings, NoiseSettings.create(0, 256, new NoiseSamplingSettings(0.9999999814507745D, 0.9999999814507745D, 80.0D, 160.0D), new NoiseSlideSettings(-10, 3, 0), new NoiseSlideSettings(15, 3, 0), 1, 2, 1.0D, -0.46875D, true, true, false, pIsAmplified), Blocks.STONE.defaultBlockState(), Blocks.WATER.defaultBlockState(), Integer.MIN_VALUE, 0, 63, 0, false, false, false, false, false, false);
   }
