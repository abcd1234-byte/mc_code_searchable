...
public class TreeConfiguration implements FeatureConfiguration {
   ...
   public static class TreeConfigurationBuilder {
      ...
      public TreeConfigurationBuilder(BlockStateProvider pTrunkProvider, TrunkPlacer pTrunkPlacer, BlockStateProvider pFoliageProvider, BlockStateProvider pSaplingProvider, FoliagePlacer pFoliagePlacer, FeatureSize pMinimumSize) {
         this.trunkProvider = pTrunkProvider;
         this.trunkPlacer = pTrunkPlacer;
         this.foliageProvider = pFoliageProvider;
         this.saplingProvider = pSaplingProvider;
