...
public class NoiseSettings {
   ...
   public static NoiseSettings create(int pMinY, int pHeight, NoiseSamplingSettings pNoiseSamplingSettings, NoiseSlideSettings pTopSlideSettings, NoiseSlideSettings pBottomSlideSettings, int pNoiseSizeHorizontal, int pNoiseSizeVertical, double pDensityFactor, double pDensityOffset, boolean pUseSimplexSurfaceNoise, boolean pRandomDensityOffset, boolean pIslandNoiseOverride, boolean pIsAmplified) {
      NoiseSettings noisesettings = new NoiseSettings(pMinY, pHeight, pNoiseSamplingSettings, pTopSlideSettings, pBottomSlideSettings, pNoiseSizeHorizontal, pNoiseSizeVertical, pDensityFactor, pDensityOffset, pUseSimplexSurfaceNoise, pRandomDensityOffset, pIslandNoiseOverride, pIsAmplified);
