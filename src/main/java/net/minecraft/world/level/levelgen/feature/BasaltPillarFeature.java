...
public class BasaltPillarFeature extends Feature<NoneFeatureConfiguration> {
   ...
   private void placeBaseHangOff(LevelAccessor pLevel, Random pRandom, BlockPos pPos) {
   ...
   private boolean placeHangOff(LevelAccessor pLevel, Random pRandom, BlockPos pPos) {
