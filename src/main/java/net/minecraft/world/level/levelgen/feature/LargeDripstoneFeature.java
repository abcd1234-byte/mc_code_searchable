...
public class LargeDripstoneFeature extends Feature<LargeDripstoneConfiguration> {
   ...
   private static LargeDripstoneFeature.LargeDripstone makeDripstone(BlockPos pRoot, boolean pPointingUp, Random pRandom, int pRadius, FloatProvider pBluntnessBase, FloatProvider pScaleBase) {
   ...
   static final class LargeDripstone {
      ...
      void placeBlocks(WorldGenLevel pLevel, Random pRandom, LargeDripstoneFeature.WindOffsetter pWindOffsetter) {
