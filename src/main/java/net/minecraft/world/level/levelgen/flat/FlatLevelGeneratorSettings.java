...
public class FlatLevelGeneratorSettings {
   ...
   public FlatLevelGeneratorSettings(StructureSettings pStructureSettings, Registry<Biome> pBiomes) {
      this.biomes = pBiomes;
      this.structureSettings = pStructureSettings;
      this.biome = () -> {
   ...
   public FlatLevelGeneratorSettings withStructureSettings(StructureSettings pStructureSettings) {
      return this.withLayers(this.layersInfo, pStructureSettings);
   }

   public FlatLevelGeneratorSettings withLayers(List<FlatLayerInfo> pLayersInfo, StructureSettings pStructureSettings) {
      FlatLevelGeneratorSettings flatlevelgeneratorsettings = new FlatLevelGeneratorSettings(pStructureSettings, this.biomes);

      for(FlatLayerInfo flatlayerinfo : pLayersInfo) {
   ...
   public static FlatLevelGeneratorSettings getDefault(Registry<Biome> pBiomes) {
      ...
      FlatLevelGeneratorSettings flatlevelgeneratorsettings = new FlatLevelGeneratorSettings(structuresettings, pBiomes);
