...
public class SinglePoolElement extends StructurePoolElement {
   ...
   public List<StructureTemplate.StructureBlockInfo> getShuffledJigsawBlocks(StructureManager pTemplateManager, BlockPos pPos, Rotation pRotation, Random pRandom) {
