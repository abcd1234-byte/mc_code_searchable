...
public class IcebergFeature extends Feature<BlockStateConfiguration> {
   ...
   private void generateCutOut(Random pRandom, LevelAccessor pLevel, int pMajorAxis, int pHeight, BlockPos pPos, boolean pElliptical, int pEllipseRadius, double pAngle, int pMinorAxis) {
   ...
   private void generateIcebergBlock(LevelAccessor pLevel, Random pRandom, BlockPos pPos, int pHeight, int pLocalX, int pLocalY, int pLocalZ, int pRadius, int pMajorRadius, boolean pElliptical, int pMinorRadius, double pAngle, boolean pPlaceSnow, BlockState pState) {
