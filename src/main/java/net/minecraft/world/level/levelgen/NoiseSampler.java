...
public class NoiseSampler {
   ...
   private double computeInitialDensity(int pY, double pDepth, double pScale, double pRandomDensityOffset) {
   ...
   private double applySlide(double pNoise, int pY) {
   ...
   private double getRandomDensity(int pX, int pZ) {
