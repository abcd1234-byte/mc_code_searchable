...
public class VillagerTrades {
   ...
   static class ItemsForEmeralds implements VillagerTrades.ItemListing {
      ...
      public ItemsForEmeralds(ItemStack pItemStack, int pEmeralCost, int pNumberOfItems, int pMaxUses, int pVillagerXp, float pPriceMultiplier) {
   ...
   static class SuspisciousStewForEmerald implements VillagerTrades.ItemListing {
      ...
      public SuspisciousStewForEmerald(MobEffect pEffect, int pDuration, int pXp) {
         this.effect = pEffect;
   ...
   static class TreasureMapForEmeralds implements VillagerTrades.ItemListing {
      ...
      public TreasureMapForEmeralds(int pEmeraldCost, StructureFeature<?> pDestination, MapDecoration.Type pDestinationType, int pMaxUses, int pVillagerXp) {
         this.emeraldCost = pEmeraldCost;
