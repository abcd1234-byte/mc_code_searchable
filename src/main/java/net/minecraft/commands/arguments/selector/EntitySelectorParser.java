...
public class EntitySelectorParser {
   ...
   private static void fillSelectorSuggestions(SuggestionsBuilder pBuilder) {
      pBuilder.suggest("@p", new TranslatableComponent("argument.entity.selector.nearestPlayer"));
      pBuilder.suggest("@a", new TranslatableComponent("argument.entity.selector.allPlayers"));
      pBuilder.suggest("@r", new TranslatableComponent("argument.entity.selector.randomPlayer"));
      pBuilder.suggest("@s", new TranslatableComponent("argument.entity.selector.self"));
      pBuilder.suggest("@e", new TranslatableComponent("argument.entity.selector.allEntities"));
   }
