...
public class KeyboardHandler {
   ...
   private void debugFeedbackTranslated(String pMessage, Object... pArgs) {
      this.debugFeedbackComponent(new TranslatableComponent(pMessage, pArgs));
   }

   private void debugWarningTranslated(String pMessage, Object... pArgs) {
      this.debugComponent(ChatFormatting.RED, new TranslatableComponent(pMessage, pArgs));
   }

   private void debugFeedback(String pMessage, Object... pArgs) {
      this.debugFeedbackComponent(new TextComponent(MessageFormat.format(pMessage, pArgs)));
   }
   ...
   public void keyPress(long pWindowPointer, int pKey, int pScanCode, int pAction, int pModifiers) {
      if (pWindowPointer == this.minecraft.getWindow().getWindow()) {
         ...
         if (pAction == 1 && (!(this.minecraft.screen instanceof ControlsScreen) || ((ControlsScreen)screen).lastKeySelection <= Util.getMillis() - 20L)) {
