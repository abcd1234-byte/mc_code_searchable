...
public class Options {
   ...
   interface FieldAccess {
      int process(String pPrefix, int pValue);

      boolean process(String pPrefix, boolean pValue);

      String process(String pPrefix, String pValue);

      double process(String pPrefix, double pValue);

      float process(String pPrefix, float pValue);
