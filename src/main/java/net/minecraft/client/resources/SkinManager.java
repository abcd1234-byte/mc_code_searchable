...
public class SkinManager {
   ...
   private ResourceLocation registerTexture(MinecraftProfileTexture pProfileTexture, Type pTextureType, @Nullable SkinManager.SkinTextureCallback pSkinAvailableCallback) {
   ...
   public interface SkinTextureCallback {
      void onSkinTextureAvailable(Type pTextureType, ResourceLocation pLocation, MinecraftProfileTexture pProfileTexture);
   }
}