...
public abstract class AbstractClientPlayer extends Player {
   ...
   public static void registerSkinTexture(ResourceLocation pTextureLocation, String pName) {
      ...
      if (abstracttexture == MissingTextureAtlasSprite.getTexture()) {
         AbstractTexture httptexture = new HttpTexture((File)null, String.format("http://skins.minecraft.net/MinecraftSkins/%s.png", StringUtil.stripColor(pName)), DefaultPlayerSkin.getDefaultSkin(createPlayerUUID(pName)), true, (Runnable)null);
