...
public class EntityRenderDispatcher implements ResourceManagerReloadListener {
   ...
   private static void renderHitbox(PoseStack pMatrixStack, VertexConsumer pBuffer, Entity pEntity, float pPartialTicks) {
      ...
      if (pEntity instanceof EnderDragon) {
         ...
         for(EnderDragonPart enderdragonpart : ((EnderDragon)pEntity).getSubEntities()) {
            pMatrixStack.pushPose();
   ...
   public void onResourceManagerReload(ResourceManager pResourceManager) {
      EntityRendererProvider.Context entityrendererprovider$context = new EntityRendererProvider.Context(this, this.itemRenderer, pResourceManager, this.entityModels, this.font);
