...
public class PlayerTabOverlay extends GuiComponent {
   ...
   public Component getNameForDisplay(PlayerInfo pPlayerInfo) {
      return pPlayerInfo.getTabListDisplayName() != null ? this.decorateName(pPlayerInfo, pPlayerInfo.getTabListDisplayName().copy()) : this.decorateName(pPlayerInfo, PlayerTeam.formatNameForTeam(pPlayerInfo.getTeam(), new TextComponent(pPlayerInfo.getProfile().getName())));
   }
